...
/**
 * de ActionListener @AnswerHandler wordt gebruikt dat als je op de knop klikt
 * dat het spel dan de antwoorden weergeeft, maar daarna kun je het niet
 * invullen doordat de knop die het controleerd uigezet (disabled) is
 * 
 * @author R Haan
 * @version 1.0
 * @since 9-3-2017
